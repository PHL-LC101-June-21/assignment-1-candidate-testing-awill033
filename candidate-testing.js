...
function gradeQuiz(candidateAnswers) {
 // TODO 1.2c: Let the candidate know if they have answered the question correctly or incorrectly // 
  ...
  let grade = (g / questions.length) * 100;
  console.log(`Your grade is: ${grade}%`);
    if (grade >= 80) {
      console.log(`Quiz passed: Congrats! You needed 80% or higher to pass!`);
    }  else {
        console.log(`Quiz failed: Sorry, you needed 80% or higher to pass.`);
      }
}
